...
/* 	body {
    ...
    <main>
        <div class="row">
            ...
            <div class="col-6">
                <div class="loginForm">
                    <form id="frmForgetPw" action="#">
                    	
                        <label class="d-block" style="font-size: 1.25rem; margin-bottom: 30px; color: #222222;">Nhập tên tài khoản</label>
                        <div>
    ...
    <script>
        ...
        $( "#frmForgetPw" ).submit(function( event ) {
        	
        	let account = $("#frmForgetPw input#account").val().trim();
        	let data = {
        		    "accountName": account
        	}
        	fetch('http://localhost:8083/user/forget-password', {
       		  method: 'POST', 
       		  headers: {
       		  ...
       		  .then((response) =>{ 
       			  if(response.status == 200){
       				window.location.href = "http://"+location.host+"/sunnyFE/account/forget/resetpw";	
       			  }
       			  else{
