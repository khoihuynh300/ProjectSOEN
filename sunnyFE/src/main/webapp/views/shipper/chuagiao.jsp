...
<style>.maintable tr > *:nth-child(2) {display: none;}</style>
	...
	<button class="grow-btn-when-hover sendtocustomer">Giao hàng</button>
		<!-- <i class="fa-solid fa-sack-dollar sendtocustomer grow-btn-when-hover"></i>
