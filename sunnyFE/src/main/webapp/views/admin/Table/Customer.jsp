	 ...
	 <div id="AddAndEdit" class="modal">
	  ...
	  <div class="modal-content">
	    ...
	    <div class="modal-body">
	    	...
	    	<label>userId:</label><input onkeydown="return false" class="obj" data-objkey="" data-objvalue="" id="userId" name="userId"><button data-inputid="userId" data-url="/usermanagement/get" class="btnchooseobj">chọn</button> </br>
